...
const tours: Tour[] = [
  // SIGNATURE TOURS
  {
    ...
    gallery: [
      '/images/downloaded/BarbudaLeisureTours-7.jpg',
      '/images/downloaded/PFA4070.jpg',
      '/images/downloaded/DSC3121-scaled.jpg',
    ],
    featured: true,
  },
  {
    ...
    gallery: [
      '/images/downloaded/Pink-Beach-North-scaled.jpg',
      '/images/downloaded/yellow-brest.jpg',
      '/images/downloaded/BarbudaLeisureTours-15.jpg',
    ],
    featured: true,
  },
  {
    ...
    gallery: [
      '/images/downloaded/BarbudaLeisureTours-3-2.jpg',
      '/images/downloaded/BarbudaLeisureTours-6.jpg',
      '/images/downloaded/Pink-Beach-North-scaled.jpg',
    ],
    featured: true,
  },
  {
    ...
    gallery: [
      '/images/downloaded/Pink-Beach-North-scaled.jpg',
      '/images/downloaded/Pink-Beach-North-scaled.jpg',
      '/images/downloaded/BarbudaLeisureTours-4.jpg',
    ],
    featured: true,
  },
  ...
  // LOCAL TOUR
  {
    ...
    gallery: [
      '/images/downloaded/BarbudaLeisureTours-6.jpg',
      '/images/downloaded/DSCF5666-2.jpg',
    ],
    featured: false,
  },
  ...
  // PRIVATE CHARTERS
  {
    ...
    gallery: [
      '/images/downloaded/BarbudaLeisureTours-8.jpg',
      '/images/downloaded/BarbudaLeisureTours-7.jpg',
      '/images/downloaded/DSC3121-scaled.jpg',
    ],
    featured: false,
  },
  {
    ...
    gallery: [
      '/images/downloaded/Allesandra-scaled.jpg',
      '/images/downloaded/BarbudaLeisureTours-3-2.jpg',
      '/images/downloaded/Pink-Beach-North-scaled.jpg',
    ],
    featured: false,
  },
  {
    ...
    gallery: [
      '/images/downloaded/BarbudaLeisureTours-12.jpg',
      '/images/downloaded/PFA4070.jpg',
      '/images/downloaded/Pink-Beach-North-scaled.jpg',
    ],
    featured: false,
