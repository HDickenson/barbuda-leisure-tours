        ...
        <div className="space-y-2 text-sm">
          {formData.partySize.adults > 0 && (
            <div className="flex justify-between text-gray-700">
              <span>
                Adults ({formData.partySize.adults}) × ${tourConfig.pricing.adult}
              </span>
          ...
          {formData.partySize.children > 0 && (
            <div className="flex justify-between text-gray-700">
              <span>
                Children ({formData.partySize.children}) × ${tourConfig.pricing.child}
              </span>
              <span className="font-medium">
          ...
          {formData.partySize.infants > 0 && (
            <div className="flex justify-between text-gray-700">
              <span>
                Infants ({formData.partySize.infants}) × ${tourConfig.pricing.infant}
              </span>
              <span className="font-medium">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <div className="flex items-start text-sm">
            ...
            <div className="text-yellow-900">
              ...
              <p className="mt-1">
                You must accept all terms to proceed with your booking request.
              </p>
            </div>
          </div>
        </div>
