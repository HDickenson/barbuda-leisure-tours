...
export const COUNTRIES = [
  'United States', 'Canada', 'United Kingdom', 'Antigua and Barbuda',
  'Australia', 'France', 'Germany', 'Italy', 'Spain', 'Netherlands',
  'Belgium', 'Switzerland', 'Austria', 'Ireland', 'New Zealand',
  'Japan', 'Brazil', 'Mexico', 'Argentina', 'Colombia',
  // Add more as needed
]
