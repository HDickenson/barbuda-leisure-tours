      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 max-h-96 overflow-y-auto">
        <div className="prose prose-sm max-w-none text-gray-700">
          ...
          <ul className="list-disc pl-5 mb-4 space-y-1">
            ...
            <li>Signature guided tours are not recommended for individuals with physical disabilities or mobility challenges</li>
          </ul>
          ...
          <ul className="list-disc pl-5 mb-4 space-y-1">
            <li>
              ...
              and boating carry inherent risks, including equipment failure, sea conditions,
              adverse weather, marine life interactions, and boarding or disembarking from boats.
            ...
            <li>
              <strong>Personal Property:</strong> Barbuda Leisure Day Tours and its partners are
              not responsible for any personal items that are lost, stolen, or damaged during the
              tour.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 mb-4 space-y-1">
            <li>Guests are responsible for ensuring they have valid identification and any required travel documents</li>
            <li>For air travel, passengers may be subject to weight and baggage restrictions imposed by the airline</li>
          </ul>
        </div>
      </div>
