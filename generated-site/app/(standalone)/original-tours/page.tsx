/**
 * Our Tours – Barbuda Leisure Day Tours
  ...
  return (
    <>
      ...
      <a
        ...
        href="https://www.barbudaleisure.com/our-tours/#content"
      >
        Skip to content{' '}
      </a>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            <li
                              id="menu-item-972"
                              className="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-960 current_page_item menu-item-972 nav-item elementskit-mobile-builder-content active"
                              data-vertical-menu="750px"
                            >
                              <a
                                href="/tours/"
      ...
      <main id="content" className="site-main post-960 page type-page status-publish hentry">
        <div className="page-content">
          <div
            data-elementor-type="wp-page"
            data-elementor-id="960"
            className="elementor elementor-960"
            data-elementor-settings="{&quot;ha_cmc_init_switcher&quot;:&quot;no&quot;}"
          >
            <section
              className="elementor-element elementor-element-9b580c5 e-flex e-con-boxed e-con e-parent e-lazyloaded animated fadeIn"
              data-id="9b580c5"
              data-element_type="container"
              data-settings="{&quot;background_background&quot;:&quot;classic&quot;,&quot;shape_divider_bottom&quot;:&quot;wave-brush&quot;,&quot;animation&quot;:&quot;fadeIn&quot;,&quot;_ha_eqh_enable&quot;:false}"
            >
              <div className="e-con-inner">
                <div
                ...
                <div
                  className="elementor-element elementor-element-2cf6756 elementor-widget elementor-widget-heading animated fadeInUp"
                  data-id="2cf6756"
                  data-element_type="widget"
                ...
                >
                  <div className="elementor-widget-container">
                    <h2 className="elementor-heading-title elementor-size-default">Tours</h2>{' '}
                  </div>
                </div>
              </div>
            </section>
            <div
              className="elementor-element elementor-element-7baf7a8f e-flex e-con-boxed e-con e-parent e-lazyloaded"
              data-id="7baf7a8f"
              data-element_type="container"
              data-settings="{&quot;background_background&quot;:&quot;classic&quot;,&quot;_ha_eqh_enable&quot;:false}"
            >
              <div className="e-con-inner">
                <div
                  className="elementor-element elementor-element-ac827c5 e-con-full e-flex e-con e-child"
                  data-id="ac827c5"
                  data-element_type="container"
                  data-settings="{&quot;_ha_eqh_enable&quot;:false}"
                >
                  <div
                    className="elementor-element elementor-element-5cc45b57 elementor-widget__width-initial ha-card--left ha-card--tablet-left elementor-widget-tablet__width-inherit ha-card--mobile-top ha-has-bg-overlay elementor-widget elementor-widget-ha-card happy-addon ha-card"
                    data-id="5cc45b57"
                    data-element_type="widget"
                    ...
                    <div className="elementor-widget-container">
                      ...
                      <div className="ha-card-body">
                        ...
                        <div className="ha-card-text">
                          <p>
                            Perfect for those wanting a full-day experience of the islandâs rich
                            heritage and natural wonders, this package offers an incredible journey
                            that begins with a scenic 15-minute flight from Antigua to Barbuda.
                          </p>
                        </div>
                        <a
                          className="ha-btn"
                  ...
                  <div
                    className="elementor-element elementor-element-3bfa03a8 elementor-widget__width-initial ha-card--left ha-card--tablet-left elementor-widget-tablet__width-inherit ha-card--mobile-top ha-has-bg-overlay elementor-widget elementor-widget-ha-card happy-addon ha-card"
                    data-id="3bfa03a8"
                    data-element_type="widget"
                    data-widget_type="ha-card.default"
                  >
                    <div className="elementor-widget-container">
                      ...
                      <div className="ha-card-body">
                        ...
                        <div className="ha-card-text">
                          <p>
                            Set sail to Barbuda on our exclusive day tour, designed for those
                            looking to uncover the islandâs hidden beauty and cultural treasures!
                          </p>
                        </div>
                        <a
                          className="ha-btn"
                  ...
                  <div
                    className="elementor-element elementor-element-e1e8fb elementor-widget__width-initial ha-card--left ha-card--tablet-left elementor-widget-tablet__width-inherit ha-card--mobile-top ha-has-bg-overlay elementor-widget elementor-widget-ha-card happy-addon ha-card"
                    data-id="e1e8fb"
                    data-element_type="widget"
                    data-widget_type="ha-card.default"
                  >
                    <div className="elementor-widget-container">
                      ...
                      <div className="ha-card-body">
                        ...
                        <div className="ha-card-text">
                          <p>
                            Experience the ultimate luxury and freedom of a private charter from
                            Antigua to Barbuda.
                          </p>
                        </div>
                        <a
                  ...
                  <div
                    className="elementor-element elementor-element-6c232e74 elementor-widget__width-initial ha-card--left ha-card--tablet-left elementor-widget-tablet__width-inherit ha-card--mobile-top ha-has-bg-overlay elementor-widget elementor-widget-ha-card happy-addon ha-card"
                    data-id="6c232e74"
                    data-element_type="widget"
                    data-widget_type="ha-card.default"
                  >
            ...
            <div
              className="elementor-element elementor-element-7cdff4a e-flex e-con-boxed e-con e-parent"
              data-id="7cdff4a"
              data-element_type="container"
              data-settings="{&quot;background_background&quot;:&quot;classic&quot;,&quot;_ha_eqh_enable&quot;:false}"
            >
              <div className="e-con-inner">
                <div
                  className="elementor-element elementor-element-786ad7a ha-has-bg-overlay elementor-widget elementor-widget-meafe-testimonial-carousel e-widget-swiper"
                  data-id="786ad7a"
                  data-element_type="widget"
                  data-settings="{&quot;btccgs_testimonial_carousel_show_carousel_loop&quot;:&quot;yes&quot;,&quot;btccgs_testimonial_carousel_layouts&quot;:&quot;1&quot;,&quot;btccgs_testimonial_carousel_show_carousel_auto&quot;:&quot;yes&quot;,&quot;btccgs_testimonial_carousel_carousel_autoplay_speed&quot;:3000}"
                  data-widget_type="meafe-testimonial-carousel.default"
                >
                  <div className="elementor-widget-container">
                    <div
                      id="786ad7a"
                      className="meafe-testimonial-carousel-main layout-1 center-aligned-content"
                    >
                      <div className="meafe-testimonial-inner-wrap">
                        <div className="swiper swiper-initialized swiper-horizontal swiper-pointer-events swiper-watch-progress swiper-backface-hidden">
                          <div
                            ...
                            id="swiper-wrapper-1bd658178ccedb98"
                            aria-live="off"
                          >
                            <div
                              className="meafe-testimonial-wrap swiper-slide swiper-slide-duplicate"
                              data-swiper-slide-index="5"
                              role="group"
                              aria-label="6 / 6"
                            >
                              <div className="meafe-testimonial-desc-wrap">
                                <div className="meafe-testimonial-desc-inner">
                                  <div className="meafe-testimonial-content">
                                    <p>
                                      An unforgettable day in paradise! Barbuda Leisure handled
                                      every detail perfectly, from the transport to the warm welcome
                                      on the island. The tour was relaxed, informative, and truly
                                      showcased Barbudaâs unique beauty. I left with wonderful
                                      memories and already plan to visit again. Highly recommend it
                                      to anyone looking to explore this stunning island!
                                    </p>{' '}
                                  </div>
                                  <div className="meafe-testimonial-designation-wrap">
                                    <div className="meafe-testimonial-reviewer-thumb"></div>
                                    <div className="meafe-testimonial-design-only-wrap">
                                      <div className="meafe-testimonial-reviewer-name">
                                        Michael L.
                                      </div>
                                    </div>
                                  </div>
                            ...
                            <div
                              className="meafe-testimonial-wrap swiper-slide swiper-slide-prev"
                            ...
                            >
                              <div className="meafe-testimonial-desc-wrap">
                                <div className="meafe-testimonial-desc-inner">
                                  <div className="meafe-testimonial-content">
                                    <p>
                                      Barbuda took our breath away! We loved every minuteâfrom the
                                      pink sands to the serene bird sanctuary, it was all
                                      picture-perfect. Our guide was wonderful and made the tour so
                                      informative and fun. Canât wait to come back for another
                                      escape with Barbuda Leisure!
                                    </p>{' '}
                                  </div>
                                  <div className="meafe-testimonial-designation-wrap">
                                    <div className="meafe-testimonial-design-only-wrap">
                            ...
                            <div
                              className="meafe-testimonial-wrap swiper-slide swiper-slide-visible swiper-slide-active"
                            ...
                            >
                              <div className="meafe-testimonial-desc-wrap">
                                <div className="meafe-testimonial-desc-inner">
                                  <div className="meafe-testimonial-content">
                                    <p>
                                      Thank you, Barbuda Leisure Day Tours, for an unforgettable
                                      day! The island is truly a hidden gem, and our experience was
                                      seamless from start to finish. The team went above and beyond
                                      to make sure we had everything we needed and more. Highly
                                      recommend the BBQ lunch and Frigate Bird Sanctuary
                                      tourâamazing sights and incredible service!
                                    </p>{' '}
                                  </div>
                                  <div className="meafe-testimonial-designation-wrap">
                                    <div className="meafe-testimonial-design-only-wrap">
                            ...
                            <div
                              className="meafe-testimonial-wrap swiper-slide swiper-slide-next"
                            ...
                            >
                              <div className="meafe-testimonial-desc-wrap">
                                <div className="meafe-testimonial-desc-inner">
                                  <div className="meafe-testimonial-content">
                                    <p>
                                      This was the highlight of our trip! Barbudaâs natural beauty
                                      is unmatched, and the beaches were simply spectacular. The
                                      whole experience was well-organized, and the staff at Barbuda
                                      Leisure were attentive, friendly, and knowledgeable. We had a
                                      great time exploring the island and loved every bit of it.
                                      Worth every penny!
                                    </p>{' '}
                                  </div>
                                  <div className="meafe-testimonial-designation-wrap">
                            ...
                            <div
                              className="meafe-testimonial-wrap swiper-slide"
                            ...
                            >
                              <div className="meafe-testimonial-desc-wrap">
                                <div className="meafe-testimonial-desc-inner">
                                  <div className="meafe-testimonial-content">
                                    <p>
                                      Absolutely the best way to see Barbuda! From the boat ride to
                                      the stunning beaches and incredible bird watching, we felt
                                      like we were in our own little paradise. The pink sand beach
                                      was even more amazing than the photos! Thanks to Barbuda
                                      Leisure for such a fantastic and hassle-free adventure!
                                    </p>{' '}
                                  </div>
                                  <div className="meafe-testimonial-designation-wrap">
                                    <div className="meafe-testimonial-reviewer-thumb"></div>
                            ...
                            >
                              <div className="meafe-testimonial-desc-wrap">
                                <div className="meafe-testimonial-desc-inner">
                                  <div className="meafe-testimonial-content">
                                    <p>
                                      I canât believe how beautiful Barbuda is, and Barbuda Leisure
                                      Day Tours made it all possible. The team was so professional
                                      and friendly, and we learned so much about the islandâs
                                      history and wildlife. Loved the personalized touches and the
                                      care they put into everything. This tour is a must-do if
                                      youâre visiting Antigua!
                                    </p>{' '}
                                  </div>
                                  <div className="meafe-testimonial-designation-wrap">
                                    <div className="meafe-testimonial-reviewer-thumb"></div>
                            ...
                            <div
                              className="meafe-testimonial-wrap swiper-slide swiper-slide-duplicate swiper-slide-duplicate-prev"
                              data-swiper-slide-index="0"
                              role="group"
                              aria-label="1 / 6"
                            >
            ...
            <div
              className="elementor-element elementor-element-7dd812b e-flex e-con-boxed e-con e-parent"
              data-id="7dd812b"
              data-element_type="container"
              data-settings="{&quot;background_background&quot;:&quot;classic&quot;,&quot;_ha_eqh_enable&quot;:false}"
            >
              <div className="e-con-inner">
                <div
                  className="elementor-element elementor-element-af4a2ee e-con-full e-flex e-con e-child"
                  data-id="af4a2ee"
                  data-element_type="container"
                  data-settings="{&quot;_ha_eqh_enable&quot;:false}"
                >
                  <div
                    className="elementor-element elementor-element-f0ea257 elementor-absolute elementor-widget__width-initial elementor-widget-tablet__width-initial elementor-widget-mobile__width-initial elementor-invisible elementor-widget elementor-widget-image"
                    data-id="f0ea257"
                    data-element_type="widget"
                    data-settings="{&quot;_position&quot;:&quot;absolute&quot;,&quot;_animation&quot;:&quot;fadeInLeft&quot;,&quot;_animation_delay&quot;:250}"
                    data-widget_type="image.default"
                  >
                    <div className="elementor-widget-container">
                      <img
                        ...
                        width="300"
                        height="300"
                        src="/images/wp-content/uploads/2024/10/BarbudaLeisureTours-7-2-300x300.jpg"
                        className="attachment-medium size-medium wp-image-394"
                        alt=""
                      />{' '}
                    </div>
                  </div>
                  <div
                    className="elementor-element elementor-element-02444cb elementor-absolute elementor-invisible elementor-widget elementor-widget-image"
                    data-id="02444cb"
                    data-element_type="widget"
                    data-settings="{&quot;_position&quot;:&quot;absolute&quot;,&quot;_animation&quot;:&quot;fadeInDown&quot;,&quot;_animation_delay&quot;:750}"
                    data-widget_type="image.default"
                  >
                    <div className="elementor-widget-container">
                      <img
                        ...
                        width="300"
                        height="300"
                        src="/images/wp-content/uploads/2024/10/BarbudaLeisureTours-8-300x300.jpg"
                        className="attachment-medium size-medium wp-image-395"
                        alt=""
                      />{' '}
                    </div>
                  </div>
                  <div
                    className="elementor-element elementor-element-81ec78e elementor-absolute elementor-invisible elementor-widget elementor-widget-image"
                    data-id="81ec78e"
                    data-element_type="widget"
                    data-settings="{&quot;_position&quot;:&quot;absolute&quot;,&quot;_animation&quot;:&quot;fadeInUp&quot;,&quot;_animation_delay&quot;:500}"
                    data-widget_type="image.default"
                  >
                    <div className="elementor-widget-container">
                      <img
                        ...
                        width="300"
                        height="300"
                        src="/images/wp-content/uploads/2024/10/BarbudaLeisureTours-6-2-300x300.jpg"
                        className="attachment-medium size-medium wp-image-393"
                        alt=""
                      />{' '}
                    </div>
                  </div>
                  <div
                    className="elementor-element elementor-element-3ddd1d8 elementor-absolute elementor-widget__width-initial elementor-widget-tablet__width-initial elementor-widget-mobile__width-initial elementor-invisible elementor-widget elementor-widget-image"
                    data-id="3ddd1d8"
                    data-element_type="widget"
                    data-settings="{&quot;_position&quot;:&quot;absolute&quot;,&quot;_animation&quot;:&quot;fadeInUp&quot;,&quot;_animation_delay&quot;:1000}"
                    data-widget_type="image.default"
                  >
                    <div className="elementor-widget-container">
                      <img
                ...
                <div
                  className="elementor-element elementor-element-aa39736 e-con-full e-flex e-con e-child"
                  data-id="aa39736"
                  data-element_type="container"
                  data-settings="{&quot;_ha_eqh_enable&quot;:false}"
                >
                  <div
                    className="elementor-element elementor-element-e625f76 elementor-widget__width-initial elementor-invisible elementor-widget elementor-widget-heading"
                    data-id="e625f76"
                    data-element_type="widget"
                    data-settings="{&quot;_animation&quot;:&quot;fadeInUp&quot;}"
                    data-widget_type="heading.default"
                  ...
                  <div
                    className="elementor-element elementor-element-9427fe5 elementor-invisible elementor-widget elementor-widget-text-editor"
                    data-id="9427fe5"
                    data-element_type="widget"
                    data-settings="{&quot;_animation&quot;:&quot;fadeInUp&quot;}"
                  ...
                  >
                    <div className="elementor-widget-container">
                      <p>We look forward to making your trip a memorable one!</p>{' '}
                    </div>
                  </div>
                </div>
              </div>
                ...
                >
                  <div className="elementor-widget-container">
                    <ul className="elementor-icon-list-items">
                      ...
                      <li className="elementor-icon-list-item">
                        <a href="https://www.barbudaleisure.com/our-tours/#">
                          <span className="elementor-icon-list-icon">
                            <svg
                              aria-hidden="true"
                              className="e-font-icon-svg e-fas-circle"
        ...
        <div className="grecaptcha-badge" data-style="bottomright">
          <div className="grecaptcha-logo">
            <iframe
              ...
              src="cid:frame-22337146285856CC32996B656DE9F0AE@mhtml.blink"
            ></iframe>
          </div>
