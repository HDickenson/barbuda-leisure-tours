/**
 * Blog – Barbuda Leisure Day Tours
  ...
  return (
    <>
      ...
      <a
        ...
        href="https://www.barbudaleisure.com/our-blog/#content"
      >
        Skip to content{' '}
      </a>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            <li
                              id="menu-item-1067"
                              className="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-983 current_page_item menu-item-1067 nav-item elementskit-mobile-builder-content active"
                              data-vertical-menu="750px"
                            >
                              <a
                                href="/blog/"
      ...
      <main id="content" className="site-main post-983 page type-page status-publish hentry">
        <div className="page-content">
          <div
            data-elementor-type="wp-page"
            data-elementor-id="983"
            className="elementor elementor-983"
            data-elementor-settings="{&quot;ha_cmc_init_switcher&quot;:&quot;no&quot;}"
          >
            <div
              className="elementor-element elementor-element-9b580c5 e-flex e-con-boxed e-con e-parent e-lazyloaded"
              data-id="9b580c5"
              data-element_type="container"
              data-settings="{&quot;background_background&quot;:&quot;classic&quot;,&quot;shape_divider_bottom&quot;:&quot;wave-brush&quot;,&quot;_ha_eqh_enable&quot;:false}"
            >
              <div className="e-con-inner">
                <div
            ...
            <div
              className="elementor-element elementor-element-d3605b5 e-flex e-con-boxed e-con e-parent e-lazyloaded"
              data-id="d3605b5"
              data-element_type="container"
              data-settings="{&quot;_ha_eqh_enable&quot;:false}"
            >
              <div className="e-con-inner">
                <div
                  className="elementor-element elementor-element-cc30552 elementor-widget elementor-widget-ucaddon_post_magazine_grid"
                  data-id="cc30552"
                  data-element_type="widget"
                  data-widget_type="ucaddon_post_magazine_grid.default"
                >
                  <div className="elementor-widget-container">
                    <link
                      id="font-awesome-4-shim-css"
                    ...
                    <div
                      id="uc_post_magazine_grid_elementor_cc30552"
                      className="post_magazine_grid ue-layout-cover uc-items-wrapper uc-filterable-grid ucfilters--grid-inited"
                      data-ajax="true"
                      data-filterbehave="ajax"
                      data-querydata="{&quot;count_posts&quot;:2,&quot;total_posts&quot;:2,&quot;page&quot;:1,&quot;num_pages&quot;:1,&quot;orderby&quot;:&quot;date&quot;,&quot;orderdir&quot;:&quot;asc&quot;}"
                    >
                      <div className="ue-grid-item">
                        <div className="ue-grid-item-image">
                          <img
                            loading="lazy"
                            decoding="async"
                            src="/images/wp-content/uploads/2024/11/DSCF5666-2-768x512.jpg"
                            alt="DSCF5666-2"
                            width="768"
                            height="512"
                          />
                          ...
                          <a
                            className="ue-grid-item-image-overlay"
                            href="https://www.barbudaleisure.com/discover-the-enchanting-island-of-barbuda-with-barbuda-leisure-day-tours/"
                            aria-label="Read more about Discover the Enchanting Island of Barbuda with Barbuda Leisure Day Tours"
                          ></a>
                        </div>
                        <div className="ue-grid-item-content">
                          <div className="ue-grid-item-title">
                            <a href="https://www.barbudaleisure.com/discover-the-enchanting-island-of-barbuda-with-barbuda-leisure-day-tours/">
                              Discover the Enchanting Island of Barbuda with Barbuda Leisure Day
                              Tours
                            </a>
                          </div>
                        </div>
                      ...
                      <div className="ue-grid-item">
                        <div className="ue-grid-item-image">
                          <img
                            loading="lazy"
                            decoding="async"
                            src="/images/wp-content/uploads/2024/11/Allesandra-768x512.jpg"
                            alt="Allesandra"
                            width="768"
                            height="512"
                          />
                          ...
                          <a
                            ...
                            aria-label="Read more about Barbudaâs Pristine Beaches: A Slice of Paradise"
                          ></a>
                        </div>
                        <div className="ue-grid-item-content">
                          <div className="ue-grid-item-title">
                            <a href="/blog/discover-the-enchanting-island-of-barbuda/">
                ...
                >
                  <div className="elementor-widget-container">
                    <ul className="elementor-icon-list-items">
                      ...
                      <li className="elementor-icon-list-item">
                        <a href="https://www.barbudaleisure.com/our-blog/#">
                          <span className="elementor-icon-list-icon">
                            <svg
                              aria-hidden="true"
                              className="e-font-icon-svg e-fas-circle"
        ...
        <div className="grecaptcha-badge" data-style="bottomright">
          <div className="grecaptcha-logo">
            <iframe
              ...
              src="cid:frame-5292DADEA9DDD7E5D7D3871166766C44@mhtml.blink"
            ></iframe>
          </div>
